...
export default function Sidebar() {
  const menuItems = [
    {
      name: "Home",
      icon: <img src={home_img} alt="Home" className="w-12 h-12" />,
      path: "/",
    },
    {
      name: "Community",
      icon: <img src={community_img} alt="community" className="w-12 h-12" />,
      path: "/community",
    },
    {
      name: "Store",
      icon: <img src={store_img} alt="Store" className="w-12 h-12" />,
      path: "/store",
    },
    {
      name: "Petcare",
      icon: <img src={petcare_img} alt="petcare" className="w-12 h-12" />,
      path: "/petcare",
    },
    {
      name: "My Pets",
      icon: <img src={mypets_img} alt="mypets" className="w-12 h-12" />,
      path: "/mypets",
    },
  ];
